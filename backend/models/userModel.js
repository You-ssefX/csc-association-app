...
const userSchema = new mongoose.Schema({
  ...
  deviceId: {
    ...
    // unique: true, // This line was explicitly commented out/removed in the incoming branch
    sparse: true // Keep this as true (it only applies if 'unique' is also present and you want to index nulls, which we don't now)
  },
  profilePicture: {
    type: String,
    default:
