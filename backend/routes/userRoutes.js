...
// This route now correctly points to the removeDeviceId function in your userController
router.put('/:userId/remove-deviceid', userController.removeDeviceId); // <--- ADDED THIS LINE
